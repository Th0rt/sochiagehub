...
ActiveRecord::Schema.define(version: 20170911020950) do
  ...
  create_table "friendcodes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.integer  "app_id"
    t.string   "friendcode"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["app_id"], name: "index_friendcodes_on_app_id", using: :btree
    t.index ["user_id", "app_id"], name: "index_friendcodes_on_user_id_and_app_id", unique: true, using: :btree
    t.index ["user_id"], name: "index_friendcodes_on_user_id", using: :btree
  end
  ...
  add_foreign_key "friendcodes", "apps"
  add_foreign_key "friendcodes", "users"
